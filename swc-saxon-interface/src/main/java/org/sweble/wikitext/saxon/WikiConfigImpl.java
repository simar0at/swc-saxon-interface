			...
			WikiConfig
{
	...
	@XmlElement()
	protected ParserConfigImpl parserConfig;
	
	@XmlElement()
	protected CompilerConfigImpl compilerConfig;
	
	protected EngineNodeFactoryImpl nodeFactory;
	...
	*/
	...
	protected WikiRuntimeInfo runtimeInfo;
	...
	{
		if (isUnmarshalling)
			ParserConfigImpl.currentWikiConfigForUnmarshalling = this;
	...
	private static boolean isUnmarshalling = false;
	...
	private static WikiConfigImpl finishImport(WikiConfigImpl config)
	{
		...
		ParserConfigImpl.currentWikiConfigForUnmarshalling = null;
	...
	private Namespaces getJaxbNamespaces()
	{
		return new Namespaces(
				...
				defaultNamespace == null ? 0 : defaultNamespace.getId(),
				templateNamespace == null ? 10 : templateNamespace.getId());
	}
